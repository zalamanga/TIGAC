...
<section class="bg-main h-screen d-flex align-items-center mb-3 position-relative overflow-hidden">
    <div class="position-relative container d-flex flex-column-reverse flex-lg-row gap-lg-3 pb-5 pb-lg-0" style="z-index: 2" data-aos="fade-down">
        <div class="d-flex flex-column justify-content-center tcall-items">
            <img src="{{ asset('images/new/tcall-by-tigac.png') }}" style="width: 329px;height: 160px;" alt="Tcall By Tigac" class="tcall-by-tigac.png">
        ...
        <div class="justify-content-end align-items-end">
            <div class="image-container">
                <img src="{{ asset('images/new/bg-tcall.png') }}" alt="TCall" class="bg-tcall img-fluid position-relative" style="height: 724px; right: -18%;">
            </div>
        </div>
    </div>
</section>
...
<section class="bg-white d-flex align-items-center justify-content-center h-full container py-5"
    ...
    <div class="text-center" data-aos="fade-down">
        <h1 class="fw-semibold" style="color:#262F67;font-family: Work Sans;
            font-size: 64px;
            font-weight: 700;
            line-height: 56px;
            letter-spacing: -1px;
        ...
        <p style="font-family: Work Sans;
            ...
            <br>
            <br>
            Collaborating with T-CALL goes beyond crafting high-quality e-liquids; it's about embarking on a shared journeytoward success.
        </p>
    </div>
</section>
{{-- End Section 2 --}}
...
{{-- Section 3 --}}
<section class="bg-white h-full overflow-hidden"
    style="min-height: 80vh">
    <div class="text-center" data-aos="fade-down">
        <div class="row">
            <div class="col-md-7" style="background-color:#262F67;">
                <img src="{{asset('images/offer-tcall.png')}}" alt="TCall Offer" class="img-fluid">
            </div>
            <div class="col-md-5" style="background-color:#262F67;">
                <h1 class="text-white" style="font-family: Work Sans;
font-size: 64px;
font-weight: 600;
line-height: 65px;
letter-spacing: -1px;
text-align: left;
margin-top:15%;
margin-right:30%;">What We Are <br> Offered ?</h1>

            <p class="text-white" style="text-align:left;margin-top:7%;margin-right:50%;font-family: Work Sans;
font-size: 18px;
font-weight: 600;">
                OEM:
            </p>
            <p class="text-white" style="text-align:left;margin-right:50%;font-family: Work Sans;
font-size: 18px;
font-weight: 500;">
...
<div class="text-center text-black" data-aos="fade-down">
    <p class="lh-lg fs-4 mb-5" style="font-family: Work Sans;
font-size: 24px;
font-weight: 500;
line-height: 40px;
letter-spacing: -1px;
...
">
    ...
    <button class="btn btn-lg py-3 border-0 btn-primary px-5" type="button" onclick="window.location.href='{{ route('pages.frontend.about') }}';">CONTACT US</button>
</div>
</section>
{{-- End Section 4 --}}
@endsection
