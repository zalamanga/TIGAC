...
@section('content')
    ...
    <div id="carouselBannerProduct" class="carousel slide mb-4">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselBannerProduct" data-bs-slide="prev">
        ...
        <button class="carousel-control-next" type="button" data-bs-target="#carouselBannerProduct" data-bs-slide="next">
            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="64" viewBox="0 0 44 64" fill="none">
    ...
    <div class="container pb-2 pb-md-3 py-lg-5 mb-5">
        <div class="mb-3">
            <img src="{{asset('images/new/logo-tcall.png')}}"
                alt="Logo-tcall" class="img-fluid mb-4" width="300"/>
