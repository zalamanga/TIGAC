...
@section('content')
    <section class="bg-gradient-main h-screen w-full">
        ...
        <div class="text-center container-fluid">
            <h1 class="fw-semibold tagline-xxl mx-auto mb-3" style="max-width: 900px">Extra <span
                    class="fw-semibold text-ogg  fst-italic">Cuan</span> Extra
                <span class="text-ogg fst-italic fw-semibold">Cincai</span> & Extra<span
                    class="text-ogg fst-italic fw-semibold">Cengli</span>
            </h1>
            <p class="text-black fs-4 lh-base mb-4 mx-auto mb-md-5" style="max-width: 1200px">Maximize your profit with
                TIGAC - Enjoy extra earnings, unbeatable deals,
