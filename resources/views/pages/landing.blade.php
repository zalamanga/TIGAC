...
#social-icons {
  ...
  <body>
    ...
    <a id="profilePicture" href="#popup">
      <img src="icon/tigacid.png" alt="Profile Picture">
    </a>
    ...
    <div id="links">
      ...
      <a class="link" href="" target="_blank">
        Hompimpa & TIGI (Order / Distributor)
      </a>
      <a class="link" href="" target="_blank">
        Pocket Rockid (Order / Distributor)
      </a>
      <a class="link" href="" target="_blank">
        Jaxel (Order / Distributor)
      </a>
      <a class="link" href="" target="_blank">
        ALLIANZ ( Order / Distributor )
      </a>
      <a class="link" href="" target="_blank">
      TCall Online Order Retail (WS)
      </a>
    </div>
<div id="social-icons">
  ...
  <a class="social-icon" href="" target="_blank">
    <img src="{{asset('icon/tokopedia-removebg-preview-removebg-preview.png')}}" alt="Tokopedia">
  </a>
  <a class="social-icon" href="" target="_blank">
    <img src="icon/shoppe-removebg-preview-removebg-preview.png" alt="Shopee">
  </a>
  <a class="social-icon" href="" target="_blank">
    <img src="icon/tiktok-removebg-preview-removebg-preview.png" alt="Tiktok">
  </a>
</div>
